...
USER="$(id -F 2>/dev/null || whoami) ($(whoami))"
...
PRE_EXE_MSG_4="Authenticating User: $USER"
...
SCRIPT_DESCRIPTION_B="ϟ Fast ${YELLOW}ꨄ Transparent ${MAGENTA}𐙚 Effortless ${RED}ᥫ᭡١٥٧٤♡"
...
SCRIPT_INFO_MSG_5="All prerequisites checked and validated — you're good to go! ${GREEN}𐦂𖨆${MAGENTA}𐀪𖨆${YELLOW}𖠋𖨆${RESET}"
